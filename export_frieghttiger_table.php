...
if($_GET['export'] == 'true'){
$query = mysqli_query($conn, 'select * from frieghttiger_table'); // Get data from Database from demo table
 
 
    $delimiter = ",";
    $filename = "frieghttiger_table_" . date('dmY') . ".csv"; // Create file name
