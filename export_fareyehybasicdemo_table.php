...
if($_GET['export'] == 'true'){
$query = mysqli_query($conn, 'select * from fareyehybasicdemo_table'); // Get data from Database from demo table
 
 
    $delimiter = ",";
    $filename = "fareyehybasicdemo_table_" . date('dmY') . ".csv"; // Create file name
