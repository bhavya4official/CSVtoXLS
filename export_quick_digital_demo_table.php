...
if($_GET['export'] == 'true'){
$query = mysqli_query($conn, 'select * from quick_digital_demo_table'); // Get data from Database from demo table
 
 
    $delimiter = ",";
    $filename = "quick_digital_demo_table_" . date('dmY') . ".csv"; // Create file name
