...
if($_GET['export'] == 'true'){
$query = mysqli_query($conn, 'select * from trucksuvidha_table'); // Get data from Database from demo table
 
 
    $delimiter = ",";
    $filename = "trucksuvidha_table_" . date('dmY') . ".csv"; // Create file name
