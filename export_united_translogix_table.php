...
if($_GET['export'] == 'true'){
$query = mysqli_query($conn, 'select * from united_translogix_table'); // Get data from Database from demo table
 
 
    $delimiter = ",";
    $filename = "united_translogix_table_" . date('dmY') . ".csv"; // Create file name
