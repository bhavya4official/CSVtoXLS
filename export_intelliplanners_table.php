...
if($_GET['export'] == 'true'){
$query = mysqli_query($conn, 'select * from intelliplanners_table'); // Get data from Database from demo table
 
 
    $delimiter = ",";
    $filename = "intelliplanners_table_table_" . date('dmY') . ".csv"; // Create file name
