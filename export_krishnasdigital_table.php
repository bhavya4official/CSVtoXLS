...
if($_GET['export'] == 'true'){
$query = mysqli_query($conn, 'select * from krishnasdigital_table'); // Get data from Database from demo table
 
 
    $delimiter = ",";
    $filename = "krishnasdigital_table_table_" . date('dmY') . ".csv"; // Create file name
