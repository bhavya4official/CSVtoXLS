...
if($_GET['export'] == 'true'){
$query = mysqli_query($conn, 'select * from intuginetechnologies_table'); // Get data from Database from demo table
 
 
    $delimiter = ",";
    $filename = "intuginetechnologies_table_" . date('dmY') . ".csv"; // Create file name
